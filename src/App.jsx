                      ...
                      <div style={{ background: "#151821", border: "1px solid #1E2133", borderRadius: 16, padding: "16px", marginBottom: 16 }}>
                        ...
                        {survey.pt && (
                          <>
                            ...
                            {survey.pt.painZones?.length > 0 && <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: "1px solid #1E2133" }}><span style={{ fontSize: 13, color: "#888" }}>통증부위</span><span style={{ fontSize: 13, color: "#FF6B6B", fontWeight: 600, textAlign: "right", maxWidth: "60%" }}>{Array.isArray(survey.pt.painZones) ? survey.pt.painZones.join(", ") : survey.pt.painZones}</span></div>}
